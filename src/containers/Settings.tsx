...
export default function Settings() {
    ...
    return(
        <div className={`settings ${quiz.settings ? "active" : ""}`}>
            <div className="decor">
            ...
            <div className="settings-block">
                ...
                <div className="settings-amount">
                    <h4>Amount questions is <b>{settings.amountQuestion}</b></h4>
                    <div className="questions-amount">
                        <input className="amount-input" type="range" name="amount" min="1" max={questions.length} value={settings.amountQuestion} step="1" onChange={handleRangeChange}/>
                    </div>
                </div>
            </div>
        </div>
